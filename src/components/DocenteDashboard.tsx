...
import { obtenerEstadisticas } from "@/services/docenteService";
...
const DocenteDashboard = () => {
  ...
  const especialidadesData = Object.entries(estadisticas.especialidades).map(([name, value], index) => ({
    name,
    value,
    color: colorsPalette[index % colorsPalette.length]
  }));
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="col-span-1">
          <CardHeader>
            <CardTitle>Docentes por Departamento</CardTitle>
          </CardHeader>
